...
import TeamManageInputs from '../components/management/TeamManageInputs';
import PlayerManageInputs from '../components/management/PlayerManageInputs';
...
function ManagementPage() {
  ...
  const[authorisation, setAuthorisation] = useState<Role>('none');
